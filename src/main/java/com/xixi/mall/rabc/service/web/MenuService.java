...
import com.xixi.mall.rabc.manage.MenuManage;
import com.xixi.mall.rabc.mapper.MenuMapper;
import com.xixi.mall.rabc.vo.MenuSimpleVo;
import com.xixi.mall.rabc.vo.MenuVo;
import com.xixi.mall.rabc.vo.RouteMetaVo;
import com.xixi.mall.rabc.vo.RouteVo;
...
public class MenuService {
    ...
    public List<MenuSimpleVo> listWithPermissions() {
        ...
        UserInfoInTokenBo userInfoInTokenBo = AuthUserContext.get();
        return menuManage.listWithPermissions(userInfoInTokenBo.getSysType());
    }

    public List<Long> listMenuIds() {
        UserInfoInTokenBo userInfoInTokenBo = AuthUserContext.get();
        return menuManage.listMenuIds(userInfoInTokenBo.getUserId());
    }
}
